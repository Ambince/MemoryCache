...
public class LocalCacheUtils {
    ...
    public Bitmap getBitmapFromLocal(String url){
        ...
        try {
            ...
            File fileD = new File(CACHE_PATH);
            File file=new File(fileD,fileName);
            System.out.println("保存到本地了....."+file.getAbsolutePath().toString());
    ...
    public void setBitmapToLocal(String url,Bitmap bitmap){
        System.out.println("保存到本地了.....");
        try {
            String fileName = MD5Encoder.encode(url);//把图片的url当做文件名,并进行MD5加密
            System.out.println("保存到本地了....."+fileName);
